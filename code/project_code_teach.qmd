...
yeild_density_all_years <- fieldweatherdata %>%
...
ggsave(
  ...
  filename = here ("teach_output", "png", "yeild_density_all_years.png"),
  height = 6,
  width = 9,
  dpi = 150
)
...
average_growing_window_testing_submission <- training_merged1 %>%
  ...
  summarise(
    day_of_year_planted = round(mean(day_of_year_planted,na.rm = TRUE)),                          day_of_year_harvested = round(mean(day_of_year_harvested,na.rm = TRUE)))
