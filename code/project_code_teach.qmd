...
merged_submission <- testing_submission1 %>%
...
>>>>>>> 383b9aa84a65ff98c6191adfecc99b521ed593c7
  # Selecting needed variables
...
weather_features_submission1 <- merged_submission_final %>%
  ...
  distinct() %>%
  mutate(
    date_planted   = ymd(paste0(year, "-01-01")) + days(date_planted - 1),
    date_harvested = ymd(paste0(year, "-01-01")) + days(date_harvested - 1)
  ) %>%
